#! /usr/bin/env python3
"""
pig_lat.py - English to Pig Latin
"""
...
for word in message.split():
    ...
    word = word.lower() # Make the word lowercase for easy translation

    # Separate the consonants at the start of the word
    prefix_consonants = ''
    while word and not word[0] in VOWELS:
    ...
    # Set the word back to its original case
    if was_upper:
        word = word.upper()
    if was_title:
        word = word.title()
